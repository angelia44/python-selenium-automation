...
# By Xpath, text
driver.find_element(By.XPATH, "//a[text()='Best Seller']")
driver.find_element(By.XPATH, "//a[text()='Best Seller' and @class='nav-a']")

# By Xpath, from parent => to child
driver.find_element(By.XPATH, "//div[@id='nav-xshop-container']//a[text()='Best Sellers']")
driver.find_element(By.XPATH, "//div[@id='nav-xshop-container']//div[@id='nav-xshop']//a[text()='Best Seller']")
